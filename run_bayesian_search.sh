...
MAXFE=200      # presupuesto total de evaluaciones de función (mismo valor para todos los nhidden)
TRIALS=1       # trials Optuna por estudio            (pruebas: 10   | producción: 50)
MODE=mixed      # continuous | discrete | mixed
TIMEOUT=300     # segundos máx por trial               (pruebas: 300  | producción: 7200)
JOBS=1          # estudios en paralelo — 1 por combinación (2 algos × 4 datasets)
export OMP_NUM_THREADS=3 # threads OpenMP por proceso C++: 8 estudios × 25 = 200 threads totales
